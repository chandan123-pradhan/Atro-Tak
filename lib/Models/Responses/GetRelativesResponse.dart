...
GetRelativesResponse getRelativesResponseFromJson(String str) => GetRelativesResponse.fromJson(json.decode(str));

String getRelativesResponseToJson(GetRelativesResponse data) => json.encode(data.toJson());
...
class GetRelativesResponse {
    ...
    factory GetRelativesResponse.fromJson(Map<String, dynamic> json) => GetRelativesResponse(
        httpStatus: json["httpStatus"],
        httpStatusCode: json["httpStatusCode"],
        success: json["success"],
        message: json["message"],
        apiName: json["apiName"],
        data: RelativesData.fromJson(json["data"]),
    );
